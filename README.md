...
<img alt="Desktop-sized screenshot of the character creation screen" src="/Users/shaigilboa/workshops/css4js/character-creator/docs/mockup.png" style="width: 100%;" />
...
<img alt="Side-by-side comparison of the current footer vs. the ideal one" src="/Users/shaigilboa/workshops/css4js/character-creator/docs/footer-fix.png" style="max-width: 500px" />
...
<img alt="Annotated mockup showing the overall width at 1024px, the header occupying 65%, and the control panels occupying 50%" src="/Users/shaigilboa/workshops/css4js/character-creator/docs/sizes.png" style="width: 100%;" />
...
<img alt="Screenshot of a shorter Chrome window, with the character truncated at the knees" src="/Users/shaigilboa/workshops/css4js/character-creator/docs/short-window.png" style="width: 100%;" />
...
<img alt="Close-up screen recording of the overflow area in the control-panel" src="/Users/shaigilboa/workshops/css4js/character-creator/docs/overflow.gif" style="width: 100%;" />
...
<img alt="Screenshot of the mockup, showing the light gray bar" src="/Users/shaigilboa/workshops/css4js/character-creator/docs/mockup.png" style="width: 100%;" />

It should sit behind the avatar (and both the perspective bar and the character should sit below the footer):

<img alt="Screen recording, showing how the character and stripe don't move as the page is scrolled" src="/Users/shaigilboa/workshops/css4js/character-creator/docs/scroll.gif" style="width: 640px; max-width: 100%" />
...
<img alt="Screen recording, showing a mobile variant of the application" src="/Users/shaigilboa/workshops/css4js/character-creator/docs/mobile-variant.gif" style="max-width: 100%" />
